...
function Elevator({ isOpen, setOpen }: props) {
    ...
    <>
      ...
      >
        ...
        <path
          ...
          strokeWidth="2"
        />
        {/* <path d="M237 36H232V521H237V36Z" fill="#711D21" /> */}
        <path
          opacity="0.22"
          d="M436.645 18.267H425.456H43.2411H33.8671H22.3765V520.984H43.2411V35.7832H425.456V520.984H446.321V18.267H436.645Z"
          fill="#E3252E"
        />
        <path d="M22.3765 9.25861H0V537.75H22.3765V9.25861Z" fill="#BD1820" />
        <path d="M469 538V9.25861L446.321 9.50884V538H469Z" fill="#BD1820" />
        <path
